package com.ohaola.sdk.flutter.ohlpush_plugin.impl.req;
...
public class SimulateRequest {
	 ...
	 */
	public static void sendPush(final int type, final String text, final int space, final String extras, final OHLPushCallback<Boolean> callback) {
	 ...
	 */
	public static void sendPush(final int type, final String text, final int space, final String extras, final String scheme, final String data, final OHLPushCallback<Boolean> callback) {
