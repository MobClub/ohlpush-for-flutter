...
import 'package:ohlpush_plugin/ohlpush_local_notification.dart';
  ...
  void _send() async {
    if (_controller.text.isNotEmpty) {
      if (Platform.isIOS) {    // iOS
        OHLPushLocalNotification localNotification = new OHLPushLocalNotification(
          title: "正标题",//本地通知标题
        ...
        await OhlpushPlugin.addLocalNotification(localNotification);
      } else { // Android
        OHLPushLocalNotification localNotification = new OHLPushLocalNotification(
