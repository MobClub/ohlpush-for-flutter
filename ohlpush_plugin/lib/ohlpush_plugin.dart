...
import 'ohlpush_local_notification.dart';

typedef void EventHandler(dynamic event);

class OhlpushPlugin {
  static const MethodChannel _channel =
      const MethodChannel('com.ohaola.sdk.push.methodChannel');
  static EventChannel _channelReciever =
      const EventChannel('com.ohaola.sdk.push.reciever');
  ...
  static Future<void> addLocalNotification(
      OHLPushLocalNotification localNotification) async {
...
// Android API
  ...
  /*
	 *用户设置厂商token
	 */
  static Future<void> setDeviceTokenByUser(String channel, String token) async {
    return await _channel
        .invokeMethod('setToken', {'channel': channel, 'token': token});
  }
  ...
  static Future<void> startNotificationMonitor() async {
    return await _channel.invokeMethod('startNotificationMonitor');
  }

  static Future<void> stopNotificationMonitor() async {
    return await _channel.invokeMethod('stopNotificationMonitor');
  }

  static Future<bool> isNotificationsEnabled() async {
    return await _channel.invokeMethod('isNotificationsEnabled');
  }

  static Future<bool> setUserLanguage(String language) async {
    return await _channel
        .invokeMethod('setUserLanguage', {'language': language});
  }
}
